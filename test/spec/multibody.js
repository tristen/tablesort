tape('sorts tbodys independently', function(t) {
  ...
  t.equal(tableMulti.rows[4].cells[0].innerHTML, '1');
  t.equal(tableMulti.rows[5].cells[0].innerHTML, '2');
  t.equal(tableMulti.rows[6].cells[0].innerHTML, '3');
  ...
  t.equal(tableMulti.rows[4].cells[0].innerHTML, '3');
  t.equal(tableMulti.rows[5].cells[0].innerHTML, '2');
  t.equal(tableMulti.rows[6].cells[0].innerHTML, '1');
